...
$cart = $context->cart;
$bankwire = Module::getInstanceByName('iyzicocheckoutform');
...
$bankwire->validateOrder($cart->id, Configuration::get('IYZICO_FORM_CLASS'), $total, $bankwire->displayName, NULL, array(), (int)$currency->id, false, $customer->secure_key);
